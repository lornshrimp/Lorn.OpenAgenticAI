...
namespace Lorn.OpenAgenticAI.Infrastructure.Data.Sqlite.Migrations
{
    ...
    [Migration("20250814074039_UpdateModel_20250113")]
    partial class UpdateModel_20250113
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lorn.OpenAgenticAI.Domain.Models.Execution.ExecutionStepRecord", b =>
                {
                    b.Property<string>("StepRecordId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasKey("StepRecordId");

                    b.HasIndex("ExecutionId", "StepOrder")
                        .IsUnique()
                        .HasDatabaseName("IX_SQLite_ExecutionStepRecords_Execution_Order");

                    b.HasIndex("StepStatus", "StartTime")
                        .HasDatabaseName("IX_SQLite_ExecutionStepRecords_Status_Time");

                    b.HasIndex("AgentId", "ActionName", "StartTime")
                        .HasDatabaseName("IX_SQLite_ExecutionStepRecords_Agent_Action_Time");

                    b.ToTable("ExecutionStepRecords", null, t =>
                        {
                            t.HasCheckConstraint("CK_ExecutionStepRecords_ActionName_Length", "length(ActionName) <= 100");

                            t.HasCheckConstraint("CK_ExecutionStepRecords_AgentId_Length", "length(AgentId) <= 100");

                            t.HasCheckConstraint("CK_ExecutionStepRecords_ErrorMessage_Length", "ErrorMessage IS NULL OR length(ErrorMessage) <= 1000");

                            t.HasCheckConstraint("CK_ExecutionStepRecords_StepDescription_Length", "StepDescription IS NULL OR length(StepDescription) <= 500");

                            t.HasCheckConstraint("CK_ExecutionStepRecords_StepId_Length", "length(StepId) <= 100");
                        });
                });
            ...
            modelBuilder.Entity("Lorn.OpenAgenticAI.Domain.Models.UserManagement.UserSecurityLog", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Lorn.OpenAgenticAI.Domain.Models.Execution.ExecutionStepRecord", b =>
                {
                    ...
                    b.OwnsOne("Lorn.OpenAgenticAI.Domain.Models.ValueObjects.ResourceUsage", "ResourceUsage", b1 =>
                        {
                            b1.Property<string>("ExecutionStepRecordStepRecordId")
                                .HasColumnType("TEXT");

                            b1.Property<double>("CpuUsagePercent")
                                .HasColumnType("REAL");
                            ...
                            b1.Property<long>("DiskIOBytes")
                                .HasColumnType("INTEGER");

                            b1.Property<long>("MemoryUsageBytes")
                                .HasColumnType("INTEGER");

                            b1.Property<long>("NetworkIOBytes")
                                .HasColumnType("INTEGER");

                            b1.HasKey("ExecutionStepRecordStepRecordId");

                            b1.ToTable("ExecutionStepRecords");

                            b1.WithOwner()
                                .HasForeignKey("ExecutionStepRecordStepRecordId");
                        });
